...
import {selectionIsEmpty, selectionIsBackwards, splitWithOffsets, Split, Interval} from './utils'
...
class TextAnnotator extends React.Component<TextAnnotatorProps, {}> {
  ...
  constructor(props: TextAnnotatorProps) {
    super(props)
  ...
  render() {
    ...
    const splits: Split[] = splitWithOffsets(content, value)
    return (
